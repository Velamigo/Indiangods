...
export default function RootLayout({children}:Readonly<{children:React.ReactNode}>){return <html lang="zh-CN"><body>{children}<a className="collection-fab" href="/collection">✦ 众神收藏与 PK</a></body></html>}
